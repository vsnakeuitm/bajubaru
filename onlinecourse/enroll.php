...
$course=$_POST['course'];
$sem=$_POST['sem'];
$ret=mysql_query("insert into courseenrolls(studentRegno,pincode,session,department,level,course,semester) values('$studentregno','$pincode','$session','$dept','$level','$course','$sem')");
if($ret)
{
...
<div class="form-group">
   ...
   <?php 
$sql=mysql_query("select * from session");
while($row=mysql_fetch_array($sql))
{
?>
